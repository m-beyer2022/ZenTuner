...
public final class ZenFFT {
    ...
    private let BRLow: UnsafeMutablePointer<Int>
    private let BRLowCpx: UnsafeMutablePointer<Int>
    ...
    public func compute(buf: UnsafeMutablePointer<Float>) {
        ffts1(buf, logSize, utbl, BRLowCpx)
    }
}

// MARK: - Private Compute

private func ffts1(_ ioptr: UnsafeMutablePointer<Float>, _ M: Int, _ Utbl: UnsafeMutablePointer<Float>, _ BRLow: UnsafeMutablePointer<Int>) {
...
private func fftrecurs(_ ioptr: UnsafeMutablePointer<Float>, _ M: Int, _ Utbl: UnsafeMutablePointer<Float>, _ Ustride: Int, _ NDiffU: Int, _ StageCnt: Int) {
    guard M > MCACHE else {
...
private func fftBRInit(_ M: Int, _ BRLow: UnsafeMutablePointer<Int>) {
    let Mroot_1 = M / 2 - 1
