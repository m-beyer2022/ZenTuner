...
private enum PTrackError: Error {
...
private func swift_ptrack_get_maxbin(n: Int) -> Int {
    var tmp = n, logn = -1
    while tmp > 0 {
        tmp &>>= 1
        logn += 1
...
private func ptrack(p: inout ZenPTrack, n: Int, totalpower: Double, totalloudness: Double, maxbin: Int, numpks: Int) {
...
private func swift_ptrack_pt3(npeak: inout Int, numpks: Int, peaklist: UnsafeMutablePointer<Peak>, maxbin: Int, histogram: UnsafeMutablePointer<Float>, totalloudness: Double) {
...
private func swift_ptrack_pt4(histpeak: inout HISTOPEAK, maxbin: Int, histogram: UnsafeMutablePointer<Float>) {
    var best: Float = 0
    var indx = -1
